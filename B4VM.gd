...
func run_op(s:String)->bool:
	...
	match s:
		...
		"dc": cs.push_back(dpop())
		"cd": ds.push_back(cpop())
		...
		"dv": var a = dpop(); var b = dpop(); ds.push_back(floor(b) / a)
		"md": var a = dpop(); var b = dpop(); ds.push_back(b % a)
		"sh": var a = dpop(); var b = dpop(); ds.push_back(b << a)
		...
		"eq": var a = dpop(); var b = dpop(); ds.push_back(-int(b == a))
		"lt": var a = dpop(); var b = dpop(); ds.push_back(-int(b < a))
		"zp": dpop() # "zap"
